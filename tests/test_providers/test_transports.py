...
class TestFileTransport:
    ...
    def test_prepare_sets_rsf_metadata_file_env(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_file_contents_match_asdict(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_file_is_pretty_printed(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_prepare_returns_empty_list(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_cleanup_removes_file(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_cleanup_safe_to_call_twice(self, sample_metadata: WorkflowMetadata) -> None:
...
class TestEnvTransport:
    ...
    def test_sets_rsf_workflow_name(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_stage_none_becomes_empty_string(self, minimal_metadata: WorkflowMetadata) -> None:
    ...
    def test_sets_rsf_metadata_json(self, sample_metadata: WorkflowMetadata) -> None:
...
class TestArgsTransport:
    ...
    def test_workflow_name_substitution(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_stage_substitution(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_metadata_file_substitution(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_multiple_templates(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_prepare_returns_args_list(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_empty_templates(self, sample_metadata: WorkflowMetadata) -> None:
    ...
    def test_literal_text_without_placeholders(self, sample_metadata: WorkflowMetadata) -> None:
