...
```
Generated: src/generated/orchestrator.py
  Skipped: src/handlers/example_handler.py (already exists, not overwritten)
...
1. **src/generated/orchestrator.py** was generated. This file contains the state machine execution logic derived from `workflow.yaml`.
2. **src/handlers/example_handler.py** was skipped. It already exists (created by `rsf init` in Tutorial 1), and RSF will not overwrite a handler file that you may have edited. This is the Generation Gap pattern, explained in Step 5.
...
- **src/generated/orchestrator.py** — the generated orchestrator that implements the state machine logic from `workflow.yaml`. This file is always regenerated.
- **src/handlers/__init__.py** — updated with auto-generated import statements for all Task state handlers. The orchestrator uses these imports to find your handler functions.

---

## Understanding the Orchestrator

The generated `src/generated/orchestrator.py` starts with a header like this:
...
- The orchestrator imports handler functions from the `src/handlers/` package. When you add Task states to your workflow, `rsf generate` adds the corresponding imports.
...
The handler file `src/handlers/example_handler.py` was created by `rsf init` in Tutorial 1. Open it to review:
...
```
Generated: src/generated/orchestrator.py
  Created: src/handlers/validate_order.py
  Created: src/handlers/require_approval.py
  Created: src/handlers/process_order.py
...
Open `src/handlers/validate_order.py` to see the generated stub:
...
```
Generated: src/generated/orchestrator.py
  Skipped: src/handlers/validate_order.py (already exists, not overwritten)
  Skipped: src/handlers/require_approval.py (already exists, not overwritten)
  Skipped: src/handlers/process_order.py (already exists, not overwritten)
...
- **src/generated/orchestrator.py was regenerated.** It always is. The `# DO NOT EDIT - Generated by RSF` marker on line 1 tells RSF that this file is managed and safe to overwrite. The orchestrator is pure generated code — you never edit it.
