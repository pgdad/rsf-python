...
from rsf.cli import deploy_cmd, diff_cmd, doctor_cmd, generate_cmd, import_cmd, init_cmd, inspect_cmd, logs_cmd, test_cmd, ui_cmd, validate_cmd, watch_cmd  # noqa: E402
